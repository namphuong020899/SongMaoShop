                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="header-top-left">
                                <ul class="phone-wrap">
                                    <li><span>SĐT:</span><a href="tel: 0773654022"> (+123) 123 321 345</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="logo pb-sm-30 pb-xs-30">
                                <a href="{{ route('trangchu.index') }}">
                                    <img src="{{ asset('user/images/menu/logo/1.png') }}" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-6">
                                <div class="footer-logo">
                                    <img src="{{ asset('user/images/menu/logo/1.png') }}" alt="Footer Logo">
                                    <p class="info">
                                ...
                                <ul class="des">
                                    <li>
                                        <span>Địa Chỉ: </span> 6688Princess Road, London, Greater London BAS 23JK, UK
                                    </li>
                                    <li>
                                        <span>SĐT: </span>
                            ...
                            <div class="col-lg-3">
                                <div class="footer-block">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="ml-15" href="#">090.xxx.xnxx (Mr.V)</a></li>
                                        <li>
                                            <p class="info" style="margin-bottom: 0px !important;"><i
