...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="col-sm-auto">
                    ...
                    <button type="button" class="btn btn-primary btn-pill themLaptop" title="Thêm {{ $tieude }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($sanpham as $sp)
                            ...
                            <tr>
                                ...
                                <td>{{ $sp->soluong }}</td>
                                <td class="{{ $sp->giakhuyenmai > 0 ? 'text-info font-weight-bold' : '' }}">
                                    {{ number_format($sp->giakhuyenmai > 0 ? $sp->giakhuyenmai : $sp->giaban) }}</td>
                                <td>
        ...
        {{-- Modal Them & Sua Laptop --}}
        @include('Admin.inc.inc_Laptop')
        {{-- Modal Xoa Laptop --}}
        <div class="modal fade" id="xoaLaptop" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header no-bd">
                        <h4 class="modal-title">
                ...
                success: function(res) {
                    if (res.status == 200) {
                        ...
                        if (tieude == 'xoa' || tieude == 'suagia') {
                            ...
                            $('#cpu').val(res.laptop.cpu);
                            $('#ram').val(res.laptop.ram);
                            $('#cardDoHoa').val(res.laptop.carddohoa);
                            $('#oCung').val(res.laptop.ocung);
                            $('#manHinh').val(res.laptop.manhinh);
                            $('#nhuCau').val(res.laptop.nhucau);
                            $('#tinhTrang').val(res.laptop.tinhtrang);
